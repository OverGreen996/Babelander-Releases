# Babelander asset provenance

Created for Babelander by OverGreen996, with AI-assisted design and project implementation. 以下區分可追溯處理紀錄與所有者來源確認；不以此文件宣稱一般幾何圖形、純 AI 輸出或第三方元素必然受專有著作權保護。根目錄 LICENSE 僅於作者依法享有權利的範圍適用。

| Asset | Classification / source | Processing / license scope |
|---|---|---|
| assets/logo.png / babelander.ico | 使用者提供 babelander.ico 作為設計參考，專案 image generation 產生透明金色劍環圖像 | AI-assisted／自行修改，調整色彩、透明背景與圖示尺寸；專案版型與品牌依 LICENSE |
...
## Bundled asset hashes

| File | SHA-256 |
|---|---|
| `assets/logo.png` | `4ee351cb951fe28e0605fd46b1982ef9e1893878e2b6610bc01976b654ddb861` |
| `assets/babelander.ico` | `759452a506f6555158193fc9bb3654f5ff3655f56cab96c11fa70af1971233f8` |
| `assets/chat_ornate.png` | `868022fc9a45d11eae697a8ae089a42ee4cf1b53da4891bfd9218492af75140a` |
| `assets/equipment_frames.png` | `4c14cc605ce072f47520d5aae8b4dbcfb06aad460eea90317d914b2cf1738848` |
