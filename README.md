...
[![Buy Me a Coffee — 支持 Babelander 開發](docs/assets/buy-me-a-coffee.svg)](https://buymeacoffee.com/OverGreen996)

喜歡 Babelander，歡迎請作者喝杯咖啡。支持完全自願，不影響任何功能使用。
...
| 中文 → 英文回覆 | 獨立回覆小窗可拖曳、收合並保留本次草稿；支援一鍵清除文字，翻譯後複製英文，由你自行貼回遊戲。 |
